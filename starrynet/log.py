"Logging functions for Starrynet."

import logging
from logging import Logger
import types

# Create a new loglevel, 'CLI info', which enables a Starrynet user to see only
...
class StarrynetLogger(Logger, object):
    """Starrynet-specific logger
       Enable each starrynet .py file to with one import:

       from starrynet.log import [lg, info, error]
    ...
    def __init__(self):
        ...
        Logger.__init__(self, "starrynet")
    ...
    # "An attribute inherited from starrynet.log hide this method" (sic)
